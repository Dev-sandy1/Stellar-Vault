# Stellar-Vault demo recording guide
...
Replace "Stellar-Vault" with the final branding in the end card above.
...
Stellar-Vault is an on-device fantasy football agent that negotiates trades with other agents and settles in USDt through WDK, with no cloud reasoning path and no manual trade approval.
